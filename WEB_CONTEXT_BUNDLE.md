...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:wikipedia-b5f8733c004e39a4",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-b5f8733c004e39a4",
        "url": "https://en.wikipedia.org/wiki/Nakai_conjecture"
      },
      {
        "retrieved_at": "2026-09-02T00:06:33Z",
    ...
    "statement": {
      "language": "en",
      "text": "Nakai conjecture : if a complex algebraic variety has a ring of differential operators generated by its contained derivations , then it must be smooth .",
      "version": 1
    },
    "title": "Nakai conjecture",
    "updated_at": "2026-09-08T11:09:27Z"
  },
  "problem_contract_sha256": "20fcc48b6d8ef93cdbde2bd9c26e25fb9cb69753a4c3125a156f30fa80801619"
}
```
